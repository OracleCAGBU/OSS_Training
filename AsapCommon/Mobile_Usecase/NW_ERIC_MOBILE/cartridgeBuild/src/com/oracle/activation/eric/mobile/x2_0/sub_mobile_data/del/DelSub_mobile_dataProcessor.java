...
public class DelSub_mobile_dataProcessor implements DelSub_mobile_dataProcessorInterface {
	...
	public void execute(DelSub_mobile_dataInput parms, DelSub_mobile_dataOutput output, IConnectionHandler connection,
		...
		try {
			...
			logger.logDebug("DelSub_mobile_dataProcessor: execute() - Completed step A of execution.");
