...
import com.oracle.activation.eric.mobile.x2_0.sub_mobile_data.del.DelSub_mobile_dataProcessor;
 ...
 */
abstract public class BaseDelSub_mobile_dataTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseDelSub_mobile_dataTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_data/del/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private DelSub_mobile_dataInput makeDelSub_mobile_dataInput(String filename) {
		...
		try {
			...
			DelSub_mobile_dataInput input = new DelSub_mobile_dataInput(parms);
	...
	private void runTest(String filename) {
		...
		DelSub_mobile_dataInput input = makeDelSub_mobile_dataInput(filename);

		DelSub_mobile_dataOutput output = new DelSub_mobile_dataOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, DelSub_mobile_dataInput input, DelSub_mobile_dataOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		DelSub_mobile_dataProcessor processor = new DelSub_mobile_dataProcessor();
