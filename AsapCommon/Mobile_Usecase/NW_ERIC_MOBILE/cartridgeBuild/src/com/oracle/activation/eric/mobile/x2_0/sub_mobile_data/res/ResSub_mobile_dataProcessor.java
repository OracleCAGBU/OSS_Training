...
public class ResSub_mobile_dataProcessor implements ResSub_mobile_dataProcessorInterface {
	...
	public void execute(ResSub_mobile_dataInput parms, ResSub_mobile_dataOutput output, IConnectionHandler connection,
		...
		try {
			...
			logger.logDebug("ResSub_mobile_dataProcessor: execute() - Completed step A of execution.");
