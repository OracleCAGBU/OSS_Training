 ...
 * =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
 */
package com.oracle.activation.eric.mobile.x2_0.sub_mobile_msisdn.mod.generated;

import com.oracle.activation.eric.mobile.x2_0.sub_mobile_msisdn.mod.ModSub_mobile_msisdnProcessor;
 ...
 */
abstract public class BaseModSub_mobile_msisdnTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseModSub_mobile_msisdnTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_msisdn/mod/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private ModSub_mobile_msisdnInput makeModSub_mobile_msisdnInput(String filename) {
		...
		try {
			...
			ModSub_mobile_msisdnInput input = new ModSub_mobile_msisdnInput(parms);
	...
	private void runTest(String filename) {
		...
		ModSub_mobile_msisdnInput input = makeModSub_mobile_msisdnInput(filename);

		ModSub_mobile_msisdnOutput output = new ModSub_mobile_msisdnOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, ModSub_mobile_msisdnInput input,
			ModSub_mobile_msisdnOutput output, IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		ModSub_mobile_msisdnProcessor processor = new ModSub_mobile_msisdnProcessor();
