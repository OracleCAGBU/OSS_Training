 ...
 * 
 */
public class AddSub_mobile_voiceTestCase extends BaseAddSub_mobile_voiceTestCase {

	public AddSub_mobile_voiceTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(AddSub_mobile_voiceTestCase.class);
	}
