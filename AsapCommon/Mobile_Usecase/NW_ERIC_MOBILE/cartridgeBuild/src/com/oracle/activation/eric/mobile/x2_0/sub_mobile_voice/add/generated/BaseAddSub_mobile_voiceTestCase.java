...
import com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.add.AddSub_mobile_voiceProcessor;
 ...
 */
abstract public class BaseAddSub_mobile_voiceTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseAddSub_mobile_voiceTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_voice/add/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private AddSub_mobile_voiceInput makeAddSub_mobile_voiceInput(String filename) {
		...
		try {
			...
			AddSub_mobile_voiceInput input = new AddSub_mobile_voiceInput(parms);
	...
	private void runTest(String filename) {
		...
		AddSub_mobile_voiceInput input = makeAddSub_mobile_voiceInput(filename);

		AddSub_mobile_voiceOutput output = new AddSub_mobile_voiceOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, AddSub_mobile_voiceInput input,
			AddSub_mobile_voiceOutput output, IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		AddSub_mobile_voiceProcessor processor = new AddSub_mobile_voiceProcessor();
