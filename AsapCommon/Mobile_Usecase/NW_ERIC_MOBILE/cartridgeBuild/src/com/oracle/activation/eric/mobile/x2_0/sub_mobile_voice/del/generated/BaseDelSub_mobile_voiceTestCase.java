 ...
 * =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
 */
package com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.del.generated;

import com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.del.DelSub_mobile_voiceProcessor;
 ...
 */
abstract public class BaseDelSub_mobile_voiceTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseDelSub_mobile_voiceTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_voice/del/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private DelSub_mobile_voiceInput makeDelSub_mobile_voiceInput(String filename) {
		...
		try {
			...
			DelSub_mobile_voiceInput input = new DelSub_mobile_voiceInput(parms);
	...
	private void runTest(String filename) {
		...
		DelSub_mobile_voiceInput input = makeDelSub_mobile_voiceInput(filename);

		DelSub_mobile_voiceOutput output = new DelSub_mobile_voiceOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, DelSub_mobile_voiceInput input,
			DelSub_mobile_voiceOutput output, IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		DelSub_mobile_voiceProcessor processor = new DelSub_mobile_voiceProcessor();
