 ...
 * =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
 */
package com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.res.generated;

import com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.res.ResSub_mobile_voiceProcessor;
 ...
 */
abstract public class BaseResSub_mobile_voiceTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseResSub_mobile_voiceTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_voice/res/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private ResSub_mobile_voiceInput makeResSub_mobile_voiceInput(String filename) {
		...
		try {
			...
			ResSub_mobile_voiceInput input = new ResSub_mobile_voiceInput(parms);
	...
	private void runTest(String filename) {
		...
		ResSub_mobile_voiceInput input = makeResSub_mobile_voiceInput(filename);

		ResSub_mobile_voiceOutput output = new ResSub_mobile_voiceOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, ResSub_mobile_voiceInput input,
			ResSub_mobile_voiceOutput output, IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		ResSub_mobile_voiceProcessor processor = new ResSub_mobile_voiceProcessor();
