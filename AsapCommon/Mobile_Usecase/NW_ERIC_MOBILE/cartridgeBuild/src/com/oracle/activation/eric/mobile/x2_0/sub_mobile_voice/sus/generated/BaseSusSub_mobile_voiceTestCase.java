 ...
 */
abstract public class BaseSusSub_mobile_voiceTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseSusSub_mobile_voiceTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_voice/sus/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private SusSub_mobile_voiceInput makeSusSub_mobile_voiceInput(String filename) {
		...
		try {
			...
			SusSub_mobile_voiceInput input = new SusSub_mobile_voiceInput(parms);
	...
	private void runTest(String filename) {
		...
		SusSub_mobile_voiceInput input = makeSusSub_mobile_voiceInput(filename);
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, SusSub_mobile_voiceInput input,
			SusSub_mobile_voiceOutput output, IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		SusSub_mobile_voiceProcessor processor = new SusSub_mobile_voiceProcessor();
