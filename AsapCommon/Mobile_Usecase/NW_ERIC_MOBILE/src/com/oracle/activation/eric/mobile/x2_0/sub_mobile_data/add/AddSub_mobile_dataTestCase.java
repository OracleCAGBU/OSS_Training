 ...
 * 
 */
public class AddSub_mobile_dataTestCase extends BaseAddSub_mobile_dataTestCase {

	public AddSub_mobile_dataTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(AddSub_mobile_dataTestCase.class);
	}
