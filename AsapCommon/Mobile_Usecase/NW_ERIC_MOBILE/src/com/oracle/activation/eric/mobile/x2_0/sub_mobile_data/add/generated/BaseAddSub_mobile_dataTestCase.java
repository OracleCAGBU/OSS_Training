...
import com.oracle.activation.eric.mobile.x2_0.sub_mobile_data.add.AddSub_mobile_dataProcessor;
 ...
 */
abstract public class BaseAddSub_mobile_dataTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseAddSub_mobile_dataTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_data/add/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private AddSub_mobile_dataInput makeAddSub_mobile_dataInput(String filename) {
		...
		try {
			...
			AddSub_mobile_dataInput input = new AddSub_mobile_dataInput(parms);
	...
	private void runTest(String filename) {
		...
		AddSub_mobile_dataInput input = makeAddSub_mobile_dataInput(filename);

		AddSub_mobile_dataOutput output = new AddSub_mobile_dataOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, AddSub_mobile_dataInput input, AddSub_mobile_dataOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		AddSub_mobile_dataProcessor processor = new AddSub_mobile_dataProcessor();
