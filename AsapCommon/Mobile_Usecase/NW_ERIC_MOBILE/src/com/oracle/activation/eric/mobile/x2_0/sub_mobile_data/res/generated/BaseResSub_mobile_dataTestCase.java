...
import com.oracle.activation.eric.mobile.x2_0.sub_mobile_data.res.ResSub_mobile_dataProcessor;
 ...
 */
abstract public class BaseResSub_mobile_dataTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseResSub_mobile_dataTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_data/res/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private ResSub_mobile_dataInput makeResSub_mobile_dataInput(String filename) {
		...
		try {
			...
			ResSub_mobile_dataInput input = new ResSub_mobile_dataInput(parms);
	...
	private void runTest(String filename) {
		...
		ResSub_mobile_dataInput input = makeResSub_mobile_dataInput(filename);

		ResSub_mobile_dataOutput output = new ResSub_mobile_dataOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, ResSub_mobile_dataInput input, ResSub_mobile_dataOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		ResSub_mobile_dataProcessor processor = new ResSub_mobile_dataProcessor();
