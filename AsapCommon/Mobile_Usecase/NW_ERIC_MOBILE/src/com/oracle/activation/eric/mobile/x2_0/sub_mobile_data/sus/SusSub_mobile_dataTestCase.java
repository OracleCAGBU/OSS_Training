 ...
 * 
 */
public class SusSub_mobile_dataTestCase extends BaseSusSub_mobile_dataTestCase {

	public SusSub_mobile_dataTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(SusSub_mobile_dataTestCase.class);
	}
