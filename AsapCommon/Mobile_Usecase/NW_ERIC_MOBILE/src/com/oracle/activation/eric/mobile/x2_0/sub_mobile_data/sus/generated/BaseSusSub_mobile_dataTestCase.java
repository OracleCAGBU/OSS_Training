 ...
 * =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
 */
package com.oracle.activation.eric.mobile.x2_0.sub_mobile_data.sus.generated;

import com.oracle.activation.eric.mobile.x2_0.sub_mobile_data.sus.SusSub_mobile_dataProcessor;
 ...
 */
abstract public class BaseSusSub_mobile_dataTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseSusSub_mobile_dataTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT
			+ "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_data/sus/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private SusSub_mobile_dataInput makeSusSub_mobile_dataInput(String filename) {
		...
		try {
			...
			SusSub_mobile_dataInput input = new SusSub_mobile_dataInput(parms);
	...
	private void runTest(String filename) {
		...
		SusSub_mobile_dataInput input = makeSusSub_mobile_dataInput(filename);

		SusSub_mobile_dataOutput output = new SusSub_mobile_dataOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, SusSub_mobile_dataInput input, SusSub_mobile_dataOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		SusSub_mobile_dataProcessor processor = new SusSub_mobile_dataProcessor();
