...
import com.mslv.studio.activation.implementation.BaseSystemParameters;
import com.mslv.studio.activation.implementation.ILogger;

/**
 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
 */
public class SystemParameters extends BaseSystemParameters implements ISystemParameters {

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public SystemParameters(Properties properties, JProcessor processor, Security security, ILogger logger) {
		super(properties, processor, security, logger);
	}
