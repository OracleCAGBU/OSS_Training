...
import com.oracle.activation.eric.mobile.x2_0.sub_mobile_payType.ModSub_mobile_payTypeProcessor;
 ...
 */
abstract public class BaseModSub_mobile_payTypeTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseModSub_mobile_payTypeTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT + "/com/oracle/activation/eric/mobile/x2_0/sub_mobile_payType/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private ModSub_mobile_payTypeInput makeModSub_mobile_payTypeInput(String filename) {
		...
		try {
			...
			ModSub_mobile_payTypeInput input = new ModSub_mobile_payTypeInput(parms);
	...
	private void runTest(String filename) {
		...
		ModSub_mobile_payTypeInput input = makeModSub_mobile_payTypeInput(filename);

		ModSub_mobile_payTypeOutput output = new ModSub_mobile_payTypeOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, ModSub_mobile_payTypeInput input,
			ModSub_mobile_payTypeOutput output, IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		ModSub_mobile_payTypeProcessor processor = new ModSub_mobile_payTypeProcessor();
