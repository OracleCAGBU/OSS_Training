...
public class DelSub_mobile_voiceProcessor implements DelSub_mobile_voiceProcessorInterface {
	...
	public void execute(DelSub_mobile_voiceInput parms, DelSub_mobile_voiceOutput output, IConnectionHandler connection,
		...
		try {
			...
			logger.logDebug("DelSub_mobile_voiceProcessor: execute() - Completed step A of execution.");
			...
			if (!systemParameters.isLoopback()) {
				responseCode = connHdlr.sendRequest(hm,MobConstants.REMOVE,true);
			}
			else
			{
				responseCode = connHdlr.sendRequest(hm,MobConstants.REMOVE, false);
			}
		}
