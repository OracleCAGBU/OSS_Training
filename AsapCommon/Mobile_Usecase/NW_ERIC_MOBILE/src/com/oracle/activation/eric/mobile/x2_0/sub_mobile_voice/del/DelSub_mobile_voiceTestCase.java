 ...
 */
package com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.del;
import com.oracle.activation.eric.mobile.x2_0.sub_mobile_voice.del.generated.*;
 ...
 * 
 */
public class DelSub_mobile_voiceTestCase extends BaseDelSub_mobile_voiceTestCase {

	public DelSub_mobile_voiceTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(DelSub_mobile_voiceTestCase.class);
	}
