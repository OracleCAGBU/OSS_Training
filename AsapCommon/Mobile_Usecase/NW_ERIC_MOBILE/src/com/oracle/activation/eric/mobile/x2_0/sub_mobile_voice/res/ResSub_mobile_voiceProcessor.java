...
public class ResSub_mobile_voiceProcessor implements ResSub_mobile_voiceProcessorInterface {
	...
	public void execute(ResSub_mobile_voiceInput parms, ResSub_mobile_voiceOutput output, IConnectionHandler connection,
		...
		try {
			...
			logger.logDebug("ResSub_mobile_voiceProcessor: execute() - Completed step A of execution.");
			...
			if (!systemParameters.isLoopback()) {
				responseCode = connHdlr.sendRequest(hm,MobConstants.RESUME,true);
			}
			else
			{
				responseCode = connHdlr.sendRequest(hm,MobConstants.RESUME, false);
			}
		}
