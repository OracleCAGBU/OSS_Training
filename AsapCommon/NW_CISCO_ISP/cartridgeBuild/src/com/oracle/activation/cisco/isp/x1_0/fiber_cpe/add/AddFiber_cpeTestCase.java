 ...
 * 
 */
public class AddFiber_cpeTestCase extends BaseAddFiber_cpeTestCase {

	public AddFiber_cpeTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(AddFiber_cpeTestCase.class);
	}
