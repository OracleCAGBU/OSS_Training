 ...
 */
abstract public class BaseRetrieveFiberCpeTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseRetrieveFiberCpeTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT + "/com/orcl/activation/cisco/isp/x1_0/fiber_cpe/retrieve/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private RetrieveFiberCpeInput makeRetrieveFiberCpeInput(String filename) {
		...
		try {
			...
			RetrieveFiberCpeInput input = new RetrieveFiberCpeInput(parms);
	...
	private void runTest(String filename) {
		...
		RetrieveFiberCpeInput input = makeRetrieveFiberCpeInput(filename);
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, RetrieveFiberCpeInput input, RetrieveFiberCpeOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		RetrieveFiberCpeProcessor processor = new RetrieveFiberCpeProcessor();
