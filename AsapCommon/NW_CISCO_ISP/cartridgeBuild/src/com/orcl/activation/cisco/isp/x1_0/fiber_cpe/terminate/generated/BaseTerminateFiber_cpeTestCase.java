 ...
 * =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
 */
package com.orcl.activation.cisco.isp.x1_0.fiber_cpe.terminate.generated;

import com.orcl.activation.cisco.isp.x1_0.fiber_cpe.terminate.TerminateFiber_cpeProcessor;
 ...
 */
abstract public class BaseTerminateFiber_cpeTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseTerminateFiber_cpeTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT + "/com/orcl/activation/cisco/isp/x1_0/fiber_cpe/terminate/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private TerminateFiber_cpeInput makeTerminateFiber_cpeInput(String filename) {
		...
		try {
			...
			TerminateFiber_cpeInput input = new TerminateFiber_cpeInput(parms);
	...
	private void runTest(String filename) {
		...
		TerminateFiber_cpeInput input = makeTerminateFiber_cpeInput(filename);

		TerminateFiber_cpeOutput output = new TerminateFiber_cpeOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, TerminateFiber_cpeInput input, TerminateFiber_cpeOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		TerminateFiber_cpeProcessor processor = new TerminateFiber_cpeProcessor();
