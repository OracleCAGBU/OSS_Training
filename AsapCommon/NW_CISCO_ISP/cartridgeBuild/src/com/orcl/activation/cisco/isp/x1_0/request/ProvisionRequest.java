...
public class ProvisionRequest {
    ...
    protected List<ProvisionRequest.Service> service;
    @XmlElement(name = "Credential", required = true)
    protected List<ProvisionRequest.Credential> credential;
     ...
     * {@link ProvisionRequest.Service }
     * 
     * 
     */
    public List<ProvisionRequest.Service> getService() {
        if (service == null) {
            service = new ArrayList<ProvisionRequest.Service>();
        }
        return this.service;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProvisionRequest.Credential }
     * 
     * 
     */
    public List<ProvisionRequest.Credential> getCredential() {
        if (credential == null) {
            credential = new ArrayList<ProvisionRequest.Credential>();
        }
