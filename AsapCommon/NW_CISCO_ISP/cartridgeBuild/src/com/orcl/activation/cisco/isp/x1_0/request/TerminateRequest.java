...
public class TerminateRequest {
    ...
    protected List<TerminateRequest.Credential> credential;
     ...
     * 
     */
    public List<TerminateRequest.Credential> getCredential() {
        if (credential == null) {
            credential = new ArrayList<TerminateRequest.Credential>();
        }
