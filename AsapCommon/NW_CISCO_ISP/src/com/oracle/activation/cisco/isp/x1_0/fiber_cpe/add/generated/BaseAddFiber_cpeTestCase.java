...
import com.oracle.activation.cisco.isp.x1_0.fiber_cpe.add.AddFiber_cpeProcessor;
 ...
 */
abstract public class BaseAddFiber_cpeTestCase extends TestCase {
	/*
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	public BaseAddFiber_cpeTestCase(String name) {
		super(name);
	}
	...
	private static final String TEST_FOLDER = ROOT + "/com/oracle/activation/cisco/isp/x1_0/fiber_cpe/add/test/";

	/**
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private AddFiber_cpeInput makeAddFiber_cpeInput(String filename) {
		...
		try {
			...
			AddFiber_cpeInput input = new AddFiber_cpeInput(parms);
	...
	private void runTest(String filename) {
		...
		AddFiber_cpeInput input = makeAddFiber_cpeInput(filename);

		AddFiber_cpeOutput output = new AddFiber_cpeOutput();
	 ...
	 * @generated DO NOT MODIFY THE CONTENTS OF THIS FILE.
	 */
	private void runTest(IConnectionHandler connection, AddFiber_cpeInput input, AddFiber_cpeOutput output,
			IExitType exitType, ISystemParameters systemParameters) {
		assertNotNull(exitType);

		AddFiber_cpeProcessor processor = new AddFiber_cpeProcessor();
