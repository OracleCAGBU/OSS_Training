 ...
 * 
 */
public class ChangeFiber_cpeTestCase extends BaseChangeFiber_cpeTestCase {

	public ChangeFiber_cpeTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(ChangeFiber_cpeTestCase.class);
	}
