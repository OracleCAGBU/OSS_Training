 ...
 * 
 */
public class RetrieveFiberCpeTestCase extends BaseRetrieveFiberCpeTestCase {

	public RetrieveFiberCpeTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(RetrieveFiberCpeTestCase.class);
	}
