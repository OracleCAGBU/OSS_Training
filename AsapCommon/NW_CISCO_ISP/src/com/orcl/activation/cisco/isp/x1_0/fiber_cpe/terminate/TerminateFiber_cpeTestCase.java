 ...
 * 
 */
public class TerminateFiber_cpeTestCase extends BaseTerminateFiber_cpeTestCase {

	public TerminateFiber_cpeTestCase(String name) {
		super(name);
	}
	...
	*/
	...
	public static void main(String[] args) {
		junit.textui.TestRunner.run(TerminateFiber_cpeTestCase.class);
	}
