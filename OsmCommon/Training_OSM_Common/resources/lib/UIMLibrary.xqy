...
declare variable $uimlib:techwsPrefix                       := "techws:";
declare variable $uimlib:techwsNamespace                    := "http://xmlns.oracle.com/communications/inventory/webservice/technical";
