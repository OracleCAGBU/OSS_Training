...
let $eResponseMessage                   := $soapBody/bi:captureInteractionResponse
let $eBusinessInteractionUpdate         := systeminteractionmodule:createOrderDataUpdateForCaptureInteraction($eResponseMessage, $eOrderData)
...
return
    (
        ...
        log:info($log, fn:concat('CaptureBI Response : ', $sBusinessInteractionUpdate)),
