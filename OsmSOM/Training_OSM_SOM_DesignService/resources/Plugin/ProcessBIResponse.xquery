...
let $eResponseMessage                   := $soapBody/bi:processInteractionResponse
let $eBusinessInteractionUpdate         := systeminteractionmodule:createOrderDataUpdateForDesignInteraction($eResponseMessage, $eOrderData)
