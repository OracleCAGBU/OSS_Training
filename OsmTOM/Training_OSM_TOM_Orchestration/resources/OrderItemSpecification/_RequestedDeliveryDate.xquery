...
let $requestedDeliveryDate := $inputDoc//fulfillord:DataArea/fulfillord:ProcessTechnicalOrder/fulfillord:TOL[1]/fulfillord:TOL/fulfillord:RequestedDeliveryDateTime/text()
