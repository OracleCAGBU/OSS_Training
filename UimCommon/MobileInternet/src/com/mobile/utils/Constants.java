...
public class Constants {
	...
	public static final String SA_CHANGECPE = "hangeCPE";
	public static final String SA_CHANGEUPLOADSPEED = "ChangeUploadSpeed";
	public static final String SA_CHANGEMSISDN = "ChangeMSISDN";
	public static final String SA_CHANGEPAYTYPE = "ChangePayType";
	...
	/* TELEPHONE_NUMBER SPECIFICATION */
	...
	public static final String SPEC_MOBILEINTERNET_CFS = "MobileInternet_CFS";
	...
	public static final String SPEC_MOBILEINTERNET_RFS = "MobileInternet_RFS";
	...
	public static final String SPEC_SIM = "SIM";
	
	/* LOGICAL DEVICE ACCOUNT SPECIFICATION */
	public static final String SPEC_IMSI = "IMSI";
	...
	public static final String SPEC_MOBILE = "Mobile";
	...
	public static final String PARAM_IMSIID = "IMSI";
	public static final String PARAM_ID = "ID";
	public static final String PARAM_RANGEFROM = "RangeFrom";
	public static final String PARAM_MSISDNNAME = "MSISDN_Name";
	public static final String PARAM_SIMID = "SIM_ID";
	...
	public static final String PARAM_BAROUTGOINGCALLS = "BarOutgoingCalls";
	public static final String PARAM_ROAMINGALLOWED = "RoamingAllowed";
	...
	public static final String PARAM_PARENT_VLAN_ID = "ParentVLANId";
	...
	public static final String PARAM_SERVICEPLAN = "ServicePlan";
	...
	public static final String PARAM_IMSI_CI = "IMSI_CI";
	...
	/* TELEPHONE NUMBER CHARACTERISTIC */
