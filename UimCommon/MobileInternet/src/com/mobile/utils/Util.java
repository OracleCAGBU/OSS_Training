...
public class Util {
	...
	public static Map<String,String> convertConfigItemToMap(ConfigurationItemType configItemType){
		debug("convertConfigItemToMap - START");
		
		Map<String,String> map = new HashMap<String,String>();
		for(ConfigurationItemPropertyType p : configItemType.getPropertyList()) {
		    map.put(p.getName() , p.getValue());
		}
		
		debug("convertConfigItemToMap - END");
		return map;
	}
}
